        ...
        <div className="footer-grid container">
          <motion.div className="col footer-brand" initial={{ opacity: 0, y: 6 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="footer-contact">
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=mindguardian2026@gmail.com" target="_blank" rel="noopener noreferrer" className="contact-link"><Mail size={18} /><span>mindguardian2026@gmail.com</span></a>
